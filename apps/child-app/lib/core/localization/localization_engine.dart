...
const Map<AppLocale, Map<String, String>> _resources = {
  AppLocale.en: {
    ...
    'myRewards.bonusUnknown': 'We couldn\'t check your extra minutes right now. Pull down to try again.',
    ...
    'myRewards.grantsHistoryHint': 'Every batch of minutes you\'ve won. What\'s still running is the number above.',
  ...
  AppLocale.ar: {
    ...
    'myRewards.bonusUnknown': 'مقدرناش نعرف دقايقك الزيادة دلوقتي. اسحب لتحت وجرّب تاني.',
    ...
    'myRewards.grantsHistoryHint': 'دي كل الدقايق اللي كسبتها. اللي لسه شغّال هو الرقم اللي فوق.',
